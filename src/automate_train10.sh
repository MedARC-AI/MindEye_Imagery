...
jupyter nbconvert Train_ridge_torch.ipynb --to python
...
export BATCH_SIZE=80 # 21 for multisubject / 24 for singlesubject (orig. paper used 42 for multisubject / 24 for singlesubject)
export GLOBAL_BATCH_SIZE=$((BATCH_SIZE * NUM_GPUS))
export CUDA_VISIBLE_DEVICES="3"

subj=1 

model_name="subj0${subj}_40sess_hypatia_ridge_torch"
echo model_name=${model_name}
python Train_ridge_torch.py \
    --data_path=../dataset \
    --cache_dir=../cache \
