jupyter nbconvert Train_debug.ipynb --to python
...
model_name="pretrained_subj0${subj}_40sess_hypatia_vd_dual_proj_test"
echo model_name=${model_name}
python Train_debug.py --data_path=../dataset \
    --cache_dir=../cache \
