...
subj=1
num_sessions=1
pretrain_model_name="multisubject_subj0${subj}_hypatia_vd2_session${num_sessions}"
...
model_name="pretrained_subj0${subj}_40sess_hypatia_vd2_session${num_sessions}"
