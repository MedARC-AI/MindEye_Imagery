...
jupyter nbconvert recon_inference_mi_ridge_bd_test2.ipynb --to python
...
model_name="subj0${subj}_40sess_hypatia_turbo_ridge_flat_bd_pipe"
...
for mode in "vision" "imagery"; do
        model_name="subj0${subj}_40sess_hypatia_turbo_ridge_flat"
        python recon_inference_mi_ridge_bd_test2.py \
                --model_name $model_name \
                --subj $subj \
                --mode $mode \
                --cache_dir ../cache \
