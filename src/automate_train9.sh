...
jupyter nbconvert recon_inference_mi_ridge_bd_test3.ipynb --to python
...
model_name="subj0${subj}_40sess_hypatia_turbo_ridge_flat_bd_test3_new_vd"
echo model_name=${model_name}


# for model_name in "subj0${subj}_40sess_hypatia_turbo_ridge_flat_bd_test_new_vd" "subj0${subj}_40sess_hypatia_turbo_ridge_flat_vd_clip_new_vd"; do
for mode in "vision" "imagery"; do
        # model_name="subj0${subj}_40sess_hypatia_turbo_ridge_flat"
        python recon_inference_mi_ridge_bd_test3.py \
        ...
        # model_name="subj0${subj}_40sess_hypatia_turbo_ridge_flat_bd_test_new_vd"
...
subj01_40sess_hypatia_turbo_ridge_flat_bd_test_new_vd,
subj01_40sess_hypatia_turbo_ridge_flat_vd_clip_new_vd,
subj01_40sess_hypatia_turbo_ridge_flat_bd_test3_new_vd" \
--data_path ../dataset \
--output_path ../figs/ \
--output_file methods_scatter_bd_replicate
