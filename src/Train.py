...
sys.path.insert(0, os.path.abspath('/weka/proj-fmri/jonxu/MindEye_Imagery/src/IP-Adapter'))
...
if utils.is_interactive():
    ...
    #                 --multi_subject --subj=1 --batch_size={batch_size} --num_sessions=3 \
    ...
    jupyter_args = f"--data_path=/weka/proj-medarc/shared/mindeyev2_dataset \
                    ...
                    --n_blocks=4 --max_lr=3e-4 --mixup_pct=.33 --num_epochs=150 --no-use_image_aug \
                    --ckpt_interval=1 --ckpt_saving --wandb_log \
                    --multisubject_ckpt=../train_logs/ip_adapt_multisubject_excl01"
...
f'{cache_dir}/convnext_xlarge_alpha0.75_fullckpt.pth'
...
def load_ckpt(tag,load_lr=True,load_optimizer=True,load_epoch=True,strict=True,outdir=outdir,multisubj_loading=False): 
    ...
    checkpoint = torch.load(outdir+'/last.pth', map_location='cuda')
