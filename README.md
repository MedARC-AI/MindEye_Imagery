...
This branch creates reconstructions using a ridge backbone and text/latent only recons with Flux. It is a work in progress. Both the t5 and latent vectors of this branch are very large, and so require a lot of CPU memory to train ridge models for.
